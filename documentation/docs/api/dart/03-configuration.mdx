...
| `baseDelay`                | `Duration` | Used for event loop delay calculation                                     | `Duration(microseconds: 10)`  |
| `maxDelay`                 | `Duration` | Used for event loop delay calculation                                     | `Duration(seconds: 5)`        |
...
| `cqeWaitTimeout`           | `Duration` | How long cqes should be waited on each loop iteration                     | `Duration(milliseconds: 1)`   |
