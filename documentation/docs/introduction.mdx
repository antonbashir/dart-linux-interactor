...
Then you need to load the [library](https://github.com/antonbashir/dart-linux-interactor/blob/main/dart/native/libinteractor.so) and you will be able to use DLI Native API.
...
This limitation comes from the principle: requester controls the resources.
