...
For now we have the most popular way to do it is Dart FFI. But this is to low-level way. 
...
So there is a solution - I combined all theese features into this package.
...
Secondly you need to generate FFI Bindings for the your native part.
...
The native part is here [include](https://github.com/antonbashir/dart-linux-interactor/tree/main/native/include).
